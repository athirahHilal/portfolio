...
const skillCategories: SkillCategory[] = [
  ...
  return (
    ...
    >
      <h1 className="text-5xl tracking-tight sm:text-6xl text-[#f2acb2] text-center font-sans mt-10 mb-12">
        skills()
      </h1>
      <div className="flex flex-col items-center justify-center flex-grow w-full px-4 sm:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
          {skillCategories.map((category, index) => (
            ...
            >
              <h2 className="text-2xl font-semibold text-[#f2acb2] text-center font-sans mb-4">
                {category.title}
              </h2>
              <div className="grid grid-cols-2 gap-4">
                {category.skills.map((skill, skillIndex) => (
                  ...
                  >
                    ...
                    <p className="text-sm font-medium text-[#f2acb2] group-hover:text-black transition-colors duration-300">
                      {skill.name}
                    </p>
                  </div>
                ))}
